        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
            <button
              ...
              onClick={toggle}
              className="lg:hidden mr-2 text-gray-600 hover:text-gray-900 cursor-pointer p-2 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 rounded dark:hover:bg-gray-700 dark:focus:bg-gray-700 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800"
            >
              {isOpen ? (
